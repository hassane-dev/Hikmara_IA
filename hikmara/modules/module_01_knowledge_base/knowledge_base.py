...
class KnowledgeBase:
    ...
    def add_knowledge(self, concept_name: str, content: str, source: str = None) -> int:
        ...
        :param concept_name: Le nom du concept (doit être unique).
        :param content: Le contenu ou la description du concept.
        :param source: La source de l'information (URL, nom de fichier, etc.).
        :return: L'ID de la nouvelle entrée, ou None en cas d'erreur.
        """
        if not self.conn:
            return None
    ...
    def get_knowledge(self, concept_name: str) -> dict:
        ...
        :param concept_name: Le nom du concept à rechercher.
        :return: Un dictionnaire représentant la connaissance, ou None si non trouvée.
        """
        if not self.conn:
            return None
    ...
    def update_knowledge(self, concept_name: str, new_content: str) -> bool:
        ...
        :param concept_name: Le nom du concept à mettre à jour.
        :param new_content: Le nouveau contenu pour ce concept.
    ...
    def delete_knowledge(self, concept_name: str) -> bool:
        ...
        :param concept_name: Le nom du concept à supprimer.
