...
def main():
    ...
    try:
        ...
        # Ici, on pourrait ajouter un exemple d'utilisation si nécessaire pour le test
        # Par exemple: app_controller.structured_learner.learn_concept("Test", "Ceci est un test.")
